    ...
    <Layout bodyClass="page-home">
      ...
      <div className="container pt-8 pt-md-10">
        <div className="row justify-content-start">
          <div className="col-12">
            <h2 className="title-3 text-dark mb-3">Information</h2>
          </div>
          {markdown.map(edge => (
          ...
          <div className="col-12 text-center">
            <Link className="button button-primary mt-2" to="/information">
      ...
      <div className="container pt-5 pb-5 pt-md-7 pb-md-7">
        <div className="row justify-content-center">
          <div className="col-12">
            <h2 className="title-3 text-dark mb-4">Core Principles of One World Strong</h2>
          </div>
          {json.map(edge => (
...
export const query = graphql`
  query {
    allMarkdownRemark(
      filter: { fileAbsolutePath: { regex: "/information/" } }
